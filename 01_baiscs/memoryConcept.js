...
//Stack: Stores the actual values for simple data types (like numbers). When you copy a value, it's a new, independent copy. Changing one doesn’t affect the other.
...
console.log(
  "Ye bhi change hona chahiye but nhi kyuki copy me change hua h:",
  firstName
); //Ahsan
...
console.log(
  "As expected heap memory me ek hi point ko refrence krte hain: ",
  user2.email
); //rashmikamandana.com
